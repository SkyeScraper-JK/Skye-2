...
import { LayoutDashboard, Users, Building, TrendingUp, Activity, Settings, User } from 'lucide-react';
...
const AdminBottomNavigation: React.FC = () => {
  ...
  const navItems = [
    ...
    { icon: TrendingUp, label: 'Leads', path: '/admin/leads-bookings', active: location.pathname === '/admin/leads-bookings' },
  ];
